...
class AddCoupon extends Component {
    ...
    onUpdate = e=>{
        ...
        this.props.dispatch(middleware(`coupons/${this.state.id}`).update({ name: this.state.name, value: this.state.value, type: this.state.type, description:this.state.description })).then(result => {
            this.setState({
    ...
    onSubmit=e=>{
        ...
        this.props.dispatch(middleware("coupons").postNew({ name: this.state.name, value: this.state.value, type: this.state.type, description:this.state.description })).then(result => {
            this.setState({
                success: result.message,
                taxes: result.taxes
            }, () => {
                        ...
                        <Row>
                            <Col md="6">
                                <Form.Group controlId="code">
                                    <FormInput error={code} required type="text" label="Coupon Code" value={this.state.code} name="code" onChange={this.handleInput} />
                                </Form.Group>
                            </Col>
                            <Col md="6">        
