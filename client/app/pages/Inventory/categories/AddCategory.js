...
class AddCategory extends Component {
    ...
    onSubmit = e => {
        ...
        this.props.dispatch(middleware("categories").postNew({ categoryName: this.state.categoryName, categoryDescription: this.state.categoryDescription, parent_ref_id: this.state.parent_ref_id.value })).then(result => {
            this.setState({
